<?php
    ...
    function ubah($data) {
        ...
        mysqli_query($conn, "UPDATE transaksi SET nama_konsumen = '$nama', berat = $berat, kategori = '$kategori', status = '$status', harga_satuan = $harga, harga_total = $total WHERE id = $id");
